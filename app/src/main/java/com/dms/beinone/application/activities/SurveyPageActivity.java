...
public class SurveyPageActivity extends AppCompatActivity{
    ...
    private ViewPager survey_viewpager;
    private ImageButton survey_next_button;
    private ImageButton survey_after_button;
    ...
    public void onCreate(Bundle SavedInstanceState) {
        ...
        survey_after_button = (ImageButton) findViewById(R.id.survey_back_button_after);
        survey_next_button = (ImageButton) findViewById(R.id.survey_next_button_after);
        survey_viewpager = (ViewPager) findViewById(R.id.survey_question_view_pager);
        detail_text.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

               AlertDialog.Builder alertDialogBuilder = new AlertDialog.Builder(SurveyPageActivity.this);

               alertDialogBuilder.setTitle("상세 보기");
               alertDialogBuilder.setMessage(R.string.default_intro2);
               ...
               AlertDialog maDialog = alertDialogBuilder.create();
        ...
        survey_viewpager.setAdapter(new SurveyViewPagerAdapter(SurveyPageActivity.this, surveyArrayList, getSupportFragmentManager()));
    ...
    private void setNumber_Text(int currentCout) {

        TextView questionNumber = (TextView) findViewById(R.id.survey_question_tv);
        questionNumber.setText("문항 "+Integer.toString(currentCout+1));
    }
}
